        ...
        <Box>
          ...
          <div className="f1 pl20 pr20">
            <Wrapper>
              ...
              {/* <NavLink to="/nfts" active={currentRoute.parent === 'nfts'}>NFTs</NavLink> */}
              <SelectBox
                onClick={() => {
                  setIshovered(false);
                  setIsDexhover(false);
              ...
              >
                ...
                {isExploreHover && (
                  <Selector>
                    <NavLink to="/games" active={currentRoute.parent === 'games'}>Game</NavLink>
                    <NavLink to="/nfts" active={currentRoute.parent === 'nfts'}>NFTs</NavLink>
                    <a href="https://forms.gle/eKeyD2VzRYKCMksM7" target="_blank" className="pr10">Submit Game
                    <svg
												width="12"
												height="12"
												viewBox="0 0 12 12"
              ...
              <a href="https://freemint.lootchain.com">
                Loot NFT Pad
              </a>
              <SelectBox
                onClick={() => {
